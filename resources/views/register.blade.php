...
@section('content')
    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mt-5 mb-5">
            ...
            <p class="mt-4 text-center text-gray-600">
                Már van fiókod? <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-500">Jelentkezz be
                    itt</a>.
            </p>
        </div>
    </body>
