...
@section('content')
    ...
    <body class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen">
        ...
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md mt-5 mb-5">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-100">Regisztráció</h1>
            ...
            <form action="{{ route('register.store') }}" method="POST">
                ...
                <!-- Felhasználónév -->
                <div class="mb-4">
                    <label for="username" class="block text-gray-700 dark:text-gray-300">Felhasználónév:</label>
                    <input type="text" name="username" id="username" value="{{ old('username') }}" required
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-400 dark:focus:border-indigo-400 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100">
                </div>
                ...
                <!-- Jelszó megerősítése -->
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-gray-700 dark:text-gray-300">Jelszó
                        megerősítése:</label>
            ...
            <p class="mt-4 text-center text-gray-600 dark:text-gray-400">
                Már van fiókod? <a href="{{ route('login') }}"
