...
@section('content')
    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mb-5 mt-5">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-gray-700">Maradjak bejelentkezve</span>
                    </label>
                </div>
            ...
            <div class="mt-6">
                <a href="{{ route('auth.google') }}"
                    class="w-full inline-flex items-center justify-center bg-white border border-gray-300 py-2 px-4 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none">
                    <svg viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="#000000">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path d="M130.55 261.1c35.248 0 64.839-11.605 86.453-31.622l-41.196-31.913c-11.024 7.688-25.82
                                                ...
                                                31.187-.527 1.465C35.393 231.798 79.49 261.1 130.55 261.1" fill="#34A853">
                            </path>
                    ...
                    </svg> <span class="text-gray-700 font-medium">Bejelentkezés Google-lel</span>
                </a>
            </div>

            <p class="mt-6 text-center text-gray-600">
                Nincs még fiókod?
                <a href="{{ route('register.create') }}" class="text-indigo-600 hover:text-indigo-500">
                    Regisztrálj itt
                </a>.
            </p>
        </div>
